...
<p>האקדמיה נולדה מתוך ההבנה שאין שתי תלמידות זהות. לכן יצרתי תוכנית לימודים ייחודית – מותאמת אישית: לרמה שלך, לקצב שלך, ולמה שהכי נכון עבורך.</p>
<p>בלי מסלולים נוקשים, בלי תבניות מוכנות – כאן בונים עבורך מסלול אישי שמאפשר לך להתפתח בדיוק בדרך שלך.</p>

<p class="align-right">• קורס מתחילות – לנשים שרוצות להיכנס לעולם הציפורניים מהצעד הראשון. נתחיל מ־0, נתקדם בקצב אישי, ובליווי צמוד שתומך בכל שלב – עד שתהיי מקצועית ובטוחה בעצמך.</p>
<p class="align-right">• השתלמויות מקצועיות – למי שכבר עובדת בתחום ורוצה לרענן ידע, ללמוד טכניקות חדשות, להתמקצע ברמות הגבוהות ביותר, ולהרחיב את סל השירותים שלה עם דוגמאות, קישוטים ועבודות ברמה בינלאומית.</p>
`,
